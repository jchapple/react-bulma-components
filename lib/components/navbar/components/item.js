...
var NavbarItem = _react.default.forwardRef(function (_ref, ref) {
  var className = _ref.className,
      ...
      props = _objectWithoutProperties(_ref, ["className", "active", "children", "dropdown", "dropdownUp", "hoverable", "renderAs"]);
